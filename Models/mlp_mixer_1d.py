...
class MLPMixer1d(nn.Module):
    ...
    def __init__(self, in_channels, dim, z_dim, patch_size, image_size, depth, token_dim, channel_dim):
        super().__init__()
...
if __name__ == "__main__":
    ...
    model = MLPMixer1d(in_channels=2, image_size=1024, patch_size=16, z_dim=1024,
